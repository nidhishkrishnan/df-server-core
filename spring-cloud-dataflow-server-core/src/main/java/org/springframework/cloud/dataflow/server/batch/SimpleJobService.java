...
public class SimpleJobService implements JobService, DisposableBean {
    ...
    public Collection<String> listJobs() {
        Set<String> jobNames = new HashSet<>(jobLocator.getJobNames());
    ...
    @Override
    public int countJobExecutionsForState(String state) throws NoSuchJobException {
        return jobExecutionDao.countJobExecutionsByState(state);
    }

    @Override
    public int countJobExecutionsForJobNameAndState(String name, String state) throws NoSuchJobException {
        checkJobExists(name);
        return jobExecutionDao.countJobExecutions(name, state);
    }
    ...
    @Override
    public Collection<JobExecutionWithStepCount> listJobExecutionsForJobWithStepCount(String jobName, String jobStatus, int start, int count) throws NoSuchJobException {
        checkJobExists(jobName);
        List<JobExecutionWithStepCount> jobExecutions = jobExecutionDao.getJobExecutionsWithStepCount(jobName, jobStatus, start, count);
        return jobExecutions;
    }
